...
def create_ui():
    ...
    if uploaded_files:
        ...
        st.info("Upload one or more CSV files containing your trading history. All calculations are performed locally.")
                ...
                if all_data:
                    ...
                    with tab_stock_details:
                        if not results_df.empty:
                            # Add disclaimer before the subtabs
                            st.info("""
                            **Understanding Stock Status:**
                            
                            - **Fully Closed**: All shares were bought and sold completely
                            - **Partially Closed**: Some shares were sold, but you still hold a portion
                            - **Open Positions**: Stocks you've purchased but haven't sold any shares yet
                            - **Errors**: Inconsistent data where sell quantity exceeds buy quantity, usually due to missing buy transactions
                            
                            If stocks appear in the Errors tab, check that all your buy transactions are included in your data.
                            """)
